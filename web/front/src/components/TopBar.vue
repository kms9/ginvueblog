    ...
    <v-app-bar mobileBreakpoint="sm" app dark flat color="indigo darken-2">
      ...
      <v-dialog max-width="800">
        <template v-slot:activator="{ on, attrs }">
          ...
          <span id="login_btn"><a href="javascript:;" onclick="return window.open('http://qqt.feibooks.com/qq/getAuthCode');"><img src="https://qzonestyle.gtimg.cn/qzone/vas/opensns/res/img/Connect_logo_7.png" alt="QQ登录" border="0"></a></span>
        </template>
